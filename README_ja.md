<div align="center" >
    ...
    <p>AiBabelEar はクロスプラットフォームのリアルタイム字幕表示ソフトウェアです。</p>
    <p>
...
[AiBabelEar ユーザーマニュアル](./docs/user-manual/ja.md)
...
macOS および Linux プラットフォームでシステムオーディオ出力を取得するには追加設定が必要です。詳細は[AiBabelEarユーザーマニュアル](./docs/user-manual/ja.md)をご覧ください。
