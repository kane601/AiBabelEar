export default {
  ...
  noti: {
    ...
    "emptyInfo": "The local model path is empty, the default directory %APPDATA%/AiVoiceEars/Vosk (Vosk) or %APPDATA%/AiVoiceEars/SOSV (SOSV) will be used automatically. Please download the model into that directory before starting.",
  ...
  engine: {
    ...
    "voskModelPathInfo": "The folder path of the model required by the Vosk caption engine. Models should be placed under %APPDATA%/AiVoiceEars/Vosk (leave empty to use this directory automatically). For more details, see the project user manual.",
    "sosvModelPathInfo": "The folder path of the model required by the SOSV caption engine. Models should be placed under %APPDATA%/AiVoiceEars/SOSV (leave empty to use this directory automatically). For more details, see the project user manual.",
