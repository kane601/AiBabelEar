export default {
  ...
  noti: {
    ...
    "empty": "モデルパスが空です",
    "emptyInfo": "選択されたローカルモデルのパスが空です。デフォルトディレクトリ %APPDATA%/AiVoiceEars/Vosk（Vosk）または %APPDATA%/AiVoiceEars/SOSV（SOSV）が自動的に使用されます。モデルをそのディレクトリにダウンロードしてから起動してください。",
  ...
  engine: {
    ...
    "voskModelPathInfo": "Vosk 字幕エンジンに必要なモデルのフォルダパスです。モデルは %APPDATA%/AiVoiceEars/Vosk に配置してください（空欄の場合は自動的にこのディレクトリを使用）。詳細情報はプロジェクトのユーザーマニュアルをご覧ください。",
    "sosvModelPathInfo": "SOSV 字幕エンジンに必要なモデルのフォルダパスです。モデルは %APPDATA%/AiVoiceEars/SOSV に配置してください（空欄の場合は自動的にこのディレクトリを使用）。詳細情報はプロジェクトのユーザーマニュアルをご覧ください。",
